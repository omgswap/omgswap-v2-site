...
OMGSwap V1 is the first version of the protocol, [launched in November 2018](https://twitter.com/haydenzadams/status/1058376395108376577) at Devcon 4. Because of its permissionless nature, it will exist for as long as Ethereum does. However, V2 includes a number of tangible improvements over V1. You are invited to explore the <Link to='/docs/v2/'>V2 documentation</Link>.

Designed with simplicity in mind, the OMGSwap protocol provides an interface for seamless exchange of ERC20 tokens on Ethereum. By eliminating unnecessary forms of rent extraction and middlemen it allows faster, more efficient exchange. Where it makes tradeoffs, decentralization, censorship resistance, and security are prioritized.

OMGSwap is open source and functions as a public good. There is no central token or platform fee. No special treatment is given to early investors, adopters, or developers. Token listing is open and free. All smart contract functions are public and all upgrades are opt-in.

This site will serve as a project overview for OMGSwap - explaining how it works, how to use it, and how to build on top of it. These docs are actively being worked on and more information will be added on an ongoing basis.

# V1 Features

- Add support for any ERC20 token using the OMGSwap [factory](https://github.com/OMGSwap/OMGSwap-v1/blob/master/contracts/OMGSwap_factory.vy)
...
- Liquidity-sensitive automated pricing using [constant product formula](https://github.com/runtimeverification/verified-smart-contracts/blob/OMGSwap/OMGSwap/x-y-k.pdf)
...
- Support for private and custom OMGSwap exchanges
- Buy ERC20 tokens from any wallet using ENS
- [Partially verified](https://github.com/runtimeverification/verified-smart-contracts/tree/OMGSwap/OMGSwap) smart contracts written in Vyper
- Mobile-optimized open source [frontend implementation](https://github.com/OMGSwap/OMGSwap-interface)
- Funded through an [Ethereum Foundation grant](https://blog.ethereum.org/2018/08/17/ethereum-foundation-grants-update-wave-3/)

# Resources

- [Website](https://OMGSwap.org)
- [Github](https://github.com/OMGSwap)
- [Twitter](https://twitter.com/OMGSwapProtocol)
- [Reddit](https://www.reddit.com/r/OMGSwap)
- [Email](mailto:contact@OMGSwap.org)
- [Whitepaper](https://hackmd.io/s/HJ9jLsfTz)

# How it works

OMGSwap is made up of a series of ETH-ERC20 exchange contracts. There is exactly one exchange contract per ERC20 token. If a token does not yet have an exchange it can be created by anyone using the OMGSwap factory contract. The factory serves as a public registry and is used to look up all token and exchange addresses added to the system.
...
[OMGSwap.org](https://OMGSwap.org) is the landing page for the OMGSwap protocol. It describes the project and directs users where they need to go.

The OMGSwap smart contracts live on Ethereum. Anyone can interact with them directly.

The OMGSwap frontend is an open source interface designed to improve user experience when interacting with the smart contracts. Anyone can use the source code to host an interface, or build their own. Hosted interfaces are independent of OMGSwap, and should comply with their jurisdictional laws and regulations.
