...
The [OMGSwap SDK](https://github.com/OMGSwap/OMGSwap-sdk/tree/v1) is meant to simplify every aspect of integrating OMGSwap into your project. It's written in [TypeScript](https://www.typescriptlang.org), has a [robust test suite](https://github.com/OMGSwap/OMGSwap-sdk/tree/v1/src/__tests__), uses [bignumber.js](https://github.com/MikeMcl/bignumber.js) for math, and includes an optional data-fetching module which relies on [ethers.js](https://github.com/ethers-io/ethers.js/).
...
- <Link to='/docs/v1/SDK/data'>Data</Link> - Fetches OMGSwap data from the blockchain
...
- <Link to='/docs/v1/SDK/transact'>Transact</Link> - Prepares computed trades for execution against OMGSwap smart contracts
...
```bash
yarn add @OMGSwap/sdk
```

...import some functions...

```javascript
import { ... } from '@OMGSwap/sdk'
```
